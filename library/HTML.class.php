...
class HTML {
	...
	function includeJs($fileName, $attr = '')
	{
		$data = '<script type="text/javascript" src="'.BASE_PATH.'js/'.$fileName.'.js" '.$attr . ' ></script>';
		return $data;
	}

	function includeCss($fileName, $attr='') 
	{
		$data = '<link href="'.BASE_PATH.'css/'.$fileName.'.css" type="text/css" rel="stylesheet" ' . $attr . ' />';
		return $data;
	}
